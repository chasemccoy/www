...
describe('rehype-figure', () => {
  it('wraps an image with a title in a figure with figcaption', () => {
    const input =
      '<p><img src="photo.jpg" alt="A photo" title="My caption"></p>'
  ...
  it('parses markdown links in the caption', () => {
    const input =
      '<p><img src="photo.jpg" title="Credit: [Source](https://example.com)"></p>'
    const output = process(input)
  ...
  it('parses inline markdown formatting in the caption', () => {
    const input =
      '<p><img src="photo.jpg" title="This is *emphasized* text"></p>'
    const output = process(input)
