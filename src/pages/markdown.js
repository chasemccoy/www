      ...
      <div className="prose">
        ...
        <pre>
          <code className="language-html">
            &lt;article class="prose"&gt;{'\n'}
            {'  '}&lt;h1&gt;Garlic bread with cheese: What the science tells
            us&lt;/h1&gt;{'\n'}
            {'  '}&lt;p&gt;{'\n'}
            {'    '}For years parents have espoused the health benefits of
            eating garlic bread with cheese to their{'\n'}
            {'    '}children, with the food earning such an iconic status in our
            culture that kids will often dress{'\n'}
            {'    '}up as warm, cheesy loaf for Halloween.{'\n'}
            {'  '}&lt;/p&gt;{'\n'}
            {'  '}&lt;p&gt;{'\n'}
            {'    '}But a recent study shows that the celebrated appetizer may
            be linked to a series of rabies cases{'\n'}
