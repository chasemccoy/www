export default [
  ...
  {
    content: "No tree, it is said, can grow to heaven unless its roots reach down to hell.",
    metadata: "Carl Jung",
  },
  {
    content:
  ...
  { content: "Think before you speak. Read before you think.", metadata: "Fran Lebowitz" },
  {
    content:
