...
import seedsScreenshot from './images/seeds-screenshot.png'
import seeds from './images/seeds.png'
import dsPlanning from './images/ds-planning.jpg'
...
const SeedsPage = () => {
  return (
    <div className='homepage--seeds mobile-breakout'>
      ...
      <div className='screenshot-container mt-32'>
        <Image
          src={seedsScreenshot}
          alt=''
          placeholder='blur'
      ...
      <section className='hyphens prose color-gray--400'>
        <div className='photo-site relative'>
          <Image
            src={seeds}
        ...
        <div className='photo-planning relative'>
          <Image
            src={dsPlanning}
        ...
        <p className='clear-right'>
          While products help to make our user’s work more correct and
          efficient, <span className='program'>programs</span> make work more
          collaborative and inclusive. These are the services and activities
          that the system team provides to their users. I like to focus on three
          in particular:
        </p>
