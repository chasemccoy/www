...
const defaults = {
  title: 'Chase McCoy',
  titleTemplate: (title) => title === 'Chase McCoy' ? title : `${title} | Chase McCoy`,
  description:
...
const Metadata = ({
  ...
  return (
    <Head>
      ...
      <meta property='og:title' content={defaults.titleTemplate(title)} key="og:title" />
      ...
      <link rel='pingback' href='https://webmention.io/chasem.co/xmlrpc' key="pingback" />
      <link href='https://twitter.com/chase_mccoy' rel='me' key="twitter" />
      <link href='https://github.com/chasemccoy' rel='me' key="github" />
      <link
        rel='webmention'
        href='https://webmention.io/chasem.co/webmention' key="webmention"
      />
      <link
        rel='authorization_endpoint'
        href='https://indieauth.com/auth' key="webmention_auth"
      />
    </Head>
  )
}
