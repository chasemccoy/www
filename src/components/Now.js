  ...
  return (
    <React.Fragment>
      <h2 className='serif normal mt-24' style={{ fontSize: '2rem' }}>
        Now
        <span
          className='sans ml-8 inline-block color-caption'
          style={{ fontSize: '0.9rem', transform: 'translateY(-1px)' }}
        >
      ...
      <p className='color-caption mt-12 smaller tighter'>
        If any of these things sounds interesting to you and you’d like to chat
        about them, please{' '}
        <Link href='mailto:hi@chasem.co'>send me a note!</Link>
      </p>
    </React.Fragment>
  )
}
