...
<template>
  ...
  <details v-if="mobile" class="Sidebar__details">
    ...
    <div>
      <SidebarContent :featured-posts="featuredPosts" :years="years" :blogroll="blogroll" />
    </div>
  </details>

  <SidebarContent v-else :featured-posts="featuredPosts" :years="years" :blogroll="blogroll" />
</template>
