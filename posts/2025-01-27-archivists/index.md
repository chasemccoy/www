...
Sure, you could store all of the same data on your computer as you could in a tool like Notion. But I think the _metadata_ those tools allow for is what is so important to preserve. A folder full of files is limiting compared to the database-ness of something like Notion.
