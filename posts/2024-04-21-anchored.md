...
This technique combines three CSS functions! `max`, `anchor`, and `cal` combine forces to anchor the sidenote to _either_ the top of the anchor, or the bottom of the previous sidenote (plus a gap), whichever is greater.
