...
I run my own little bookmarking service that stores a running log of links. It’s dead simple and dead fast and I use shortcuts on iOS and Mac to send links to it via a REST API. 
...
<div className='prose'>
  ...
  I built Broadsheet because I wanted a starting point for journeys across the web. At its core it’s a collection of links and some associated media. I also have a small text editor built into Broadsheet that allows me to jot down notes or even draft blog posts as I’m browsing and reading. This is a great example of making dedicated space for creation in the places where you’re commonly inspired.
</div>
