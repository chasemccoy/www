...
- **[Roam Research](https://roamresearch.com/) is for long term storage of notes with the goal of creating a searchable commonplace book.**

    Roam is for things that I don't necessarily need to do anything about.
