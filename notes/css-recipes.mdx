...
If your website has a white background and you're displaying images (such as user avatars), it's likely that some images might have a white or near-white background as well, which can make them hard to distinguish. Using a subtle box shadow will create a visible border for these cases that is not really noticeable otherwise like a normal border would be:
...
<Bookmark url='https://web.dev/one-line-layouts' />
...
<Bookmark url="https://defensivecss.dev/tips" />